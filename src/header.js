...
const languageContent = {
    ...
    'description-bottom': {
        'english': null,
        'japanese': '残機に気をつけよう 一度外に出てしまうと、次の挑戦のためにスピリットウェルを通して一部の知識しか持ち帰ることができなくなります。',
        ...
        'german': 'Seid vorsichtig mit euren geteilten Leben. Wenn ihr alle verliert könnt ihr nur eine begrenzte menge Wissen durch den Geisterbrunnen für den nächsten Versuch mitnehmen.',
    ...
    'stay-tuned-text': {
        ...
        'german': 'Wir sind bei der nächsten Steam-Spielevorschau 2023 mit dabei!',
    ...
    'feature-1-text-1': {
        ...
        'german': 'Opfere deinen Charakter, um Elemente zu erzeugen und diese für mächtige Kombinationen verbinden!',
    ...
    'feature-1-text-2': {
        ...
        'german': 'Nutze diese Elementareffekte um neue Gebiete freizuschalten, Feinde zu besiegen und voranzukommen.',
    ...
    'feature-1-text-3': {
        ...
        'german': 'Arbeitet zusammen um alle verschiedenen Interaktionen zu entdecken.',
    ...
    'feature-title-2': {
        'english': null,
        'japanese': 'オンラインマルチプレイ',
        'chinese': '在线多人合作游戏',
        'spanish': 'Co-op online para varios jugadores',
        'german': 'Online-Mehrspieler-Koop',
        'french': "Coopération multijoueur en ligne",
        'portuguese': 'Cooperativa multi-jogador online',
        'finnish': 'Moninpelin online-yhteispeli',
